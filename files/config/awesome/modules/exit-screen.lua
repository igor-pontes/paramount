...
--- Create the buttons
local poweroff = create_button(poweroff_text_icon, beautiful.color5, "Poweroff", poweroff_command)
local reboot = create_button(reboot_text_icon, beautiful.color5, "Reboot", reboot_command)
local suspend = create_button(suspend_text_icon, beautiful.color5, "Suspend", suspend_command)
local exit = create_button(exit_text_icon, beautiful.color5, "Exit", exit_command)
